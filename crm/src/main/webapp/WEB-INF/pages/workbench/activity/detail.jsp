...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveCreateActivityRemarkBtn").click(function () {
			...
			var activityId = '${activity.id}';//不加引号当作变量处理var activity = 214214153532313;
			//表单验证
			if(noteContent==""){
				alert("备注不能为空");
				return;
			...
			$.ajax({
				...
				success: function (data) {
					if(data.code=='1'){
						...
						htmlStr+="			<font color=\"gray\">市场活动</font> <font color=\"gray\">-</font> <b>${activity.name}</b> <small style=\"color: gray;\"> "+data.retData.createTime+" 由${sessionScope.sessionUser.name}</small>";
